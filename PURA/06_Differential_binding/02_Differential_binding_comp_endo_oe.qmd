...
bds <- readRDS(paste0(outpath, "bds_merge_endo_oe.rds"))
...
```{r}
# rds
saveRDS(bs, paste0(outpath, "merged_bs_diff_endo_oe_res.rds"))
...
rtracklayer::export.bed(up_bs, paste0("merged_bs_upbs_oevsendo.bed"))
rtracklayer::export.bed(down_bs, paste0("merged_bs_downbs_oevsendo.bed"))
rtracklayer::export.bed(up_bg, paste0("merged_bs_upbg_oevsendo.bed"))
rtracklayer::export.bed(down_bg, paste0("merged_bs_downbg_oevsendo.bed"))
